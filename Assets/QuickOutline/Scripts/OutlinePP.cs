...
public class OutlinePP : MonoBehaviour {
  ...
  private static readonly List<OutlinePP> activeOutlines = new List<OutlinePP>();

  internal static List<OutlinePP> ActiveOutlines {
    get { return activeOutlines; }
  }
  ...
  internal Material OutlineMaskMaterial {
    get { return outlineMaskMaterial; }
  }

  internal Material OutlineFillMaterial {
    get { return outlineFillMaterial; }
  }
  ...
  void OnEnable() {
    ...
    if (!activeOutlines.Contains(this)) {
